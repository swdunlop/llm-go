...
func Register(name string, fn func(map[string]string) (Interface, error)) {
...
func New(implementation string, settings map[string]string) (Interface, error) {
...
var implementations = map[string]func(map[string]string) (Interface, error){}
...
type Interface interface {
	...
	Predict(
		ctx context.Context, settings map[string]string, content []string, fn func(Prediction) error,
	) (string, error)
}
